...
perf_tab_RR <- perf_tab_RR %>% rename(oracle.coverage=o.coverage)
...
perf_tab_RD <- perf_tab_RD %>% rename(oracle.coverage=o.coverage)
...
old_sim_res_null_RR_coverage <- old_sim_res_null_RR %>% #filter(variance_estimator=="ic") %>%
  ...
  select(estimator, Qint, DetQ, iptw, bias,variance,mse,bias_se_ratio,o.coverage) %>% rename(oracle.coverage=o.coverage)
