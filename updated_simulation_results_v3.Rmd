...
old_sim_res_null_diff_coverage <- old_sim_res_null_diff %>% #filter(variance_estimator=="ic") %>%
  ...
  select(estimator, Qint, DetQ,bias,variance,mse,bias_se_ratio,o.coverage) %>% rename(oracle.coverage=o.coverage)
...
old_sim_res_v3_diff_coverage$estimator[grepl("_detQ",old_sim_res_v3_diff_coverage$filenames)] <- paste0(old_sim_res_v3_diff_coverage$estimator[grepl("_detQ",old_sim_res_v3_diff_coverage$filenames)],", Det-Q")
#old_sim_res_v3_diff_coverage$estimator[grepl("_iptw",old_sim_res_v3_diff_coverage$filenames)] <- paste0(old_sim_res_v3_diff_coverage$estimator[grepl("_iptw",old_sim_res_v3_diff_coverage$filenames)],", IPTW")
...
old_sim_res_v3_diff_coverage <- old_sim_res_v3_diff_coverage %>% 
  select(estimator, bias, variance, mse, o.coverage) %>% arrange(o.coverage)  %>% rename(oracle.coverage=o.coverage) %>% distinct()
