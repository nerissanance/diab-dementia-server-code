...
#for(i in 1:length(d_wide_list)){
  ...
  saveRDS(res_df, paste0(here::here(),"/data/bootstrap/sim_res_boot_outcome_blind_no_cens_T4_",i,".RDS"))
...
saveRDS(resdf_boot, paste0(here::here(),"/data/sim_res_boot_outcome_blind_no_cens_T4.RDS"))
