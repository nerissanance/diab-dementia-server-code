...
# #test - CHECK IF Q-int function is working!
# res3 <- run_ltmle_glmnet(d_wide_list[[1]], resdf=NULL, Qint=TRUE, det.Q=FALSE, varmethod = "ic",N_time=11)
# res4 <- run_ltmle_glmnet(d_wide_list[[1]], resdf=NULL, Qint=TRUE, det.Q=TRUE, varmethod = "ic",N_time=11)
# res1 <- run_ltmle_glmnet(d_wide_list[[1]], resdf=NULL, Qint=FALSE, det.Q=FALSE, varmethod = "ic",N_time=11)
# res2 <- run_ltmle_glmnet(d_wide_list[[1]], resdf=NULL, Qint=FALSE, det.Q=TRUE, varmethod = "ic",N_time=11)
#
# res1$ate
# res2$ate
# res3$ate
...
saveRDS(resdf_noDetQ_Qint_ic_T11, paste0(here::here(),"/sim_res/old_null_sim_res_DetQ_Qint_ic_T11.RDS"))
...
saveRDS(resdf_noDetQ_ic_glm_T11, paste0(here::here(),"/sim_res/old_null_sim_res_Qint_noDetQ_ic_glm_T11.RDS"))
...
saveRDS(resdf_ic_glm_T11, paste0(here::here(),"/sim_res/old_null_sim_res_Qint_ic_glm_T11.RDS"))
...
#Q-intercept has no effect on results, but deterministic Q does
...
int.start.time <- Sys.time()
resdf_DetQ_ic_T11 <- foreach(i = 1:length(d_wide_list), .combine = 'bind_rows', .errorhandling = 'remove') %dopar% {
  res <- NULL
  try(res <- run_ltmle_glmnet(d_wide_list[[i]], resdf=NULL, Qint=FALSE, det.Q=TRUE, varmethod = "ic",N_time=11))
  return(res)
}
saveRDS(resdf_DetQ_ic_T11, paste0(here::here(),"/sim_res/old_null_sim_res_ic_T11.RDS"))
