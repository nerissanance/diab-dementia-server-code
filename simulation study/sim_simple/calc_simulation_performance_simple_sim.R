...
d <- bind_rows(
  data.frame(resdf_ic_glm, analysis="ic_glm"),
  data.frame(resdf_tmle_glm, analysis="tmle_glm"),
  data.frame(resdf_ic_glmnet, analysis="ic_glmnet"),
  data.frame(resdf_tmle_glmnet, analysis="tmle_glmnet"))
