...
d_ic <- readRDS("null_no_cens_sim_res_noDetQ_ic_T11.RDS")
d_tmle <- readRDS("null_no_cens_sim_res_noDetQ_tmle_T11.RDS")
summary(d_ic$estimate)
summary(d_tmle$estimate)
summary(d_ic$estimate)


null_no_cens_sim_res_noDetQ_tmle_T11
null_no_cens_sim_res_noDetQ_ic_T11
...
unique(d$analysis)
df<-d %>% filter(analysis=="null_sim_res_noDetQ_ic_T11")
df2<-d %>% filter(analysis=="null_sim_res_ic_T11")
...
boot_iter_files <- boot_iter_files[grepl("null_T11",boot_iter_files)]
...
# Save data
#--------------------------------
save(d_T10, perf_tab_RR, perf_tab_diff, file = paste0(here::here(),"/simulation study/sim_performance_results/T10_null_sim_res.Rdata"))
