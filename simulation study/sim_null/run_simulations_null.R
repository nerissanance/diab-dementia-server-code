...
saveRDS(resdf_noDetQ_tmle, paste0(here::here(),"/sim_res/null_sim_res_noDetQ_tmle_T11.RDS"))
...
saveRDS(resdf_ic, paste0(here::here(),"/sim_res/null_sim_res_ic_T11.RDS"))
...
saveRDS(resdf_noDetQ_Qint_ic, paste0(here::here(),"/sim_res/null_sim_res_noDetQ_ic_T11.RDS"))
...
saveRDS(resdf_noDetQ_tmle, paste0(here::here(),"/sim_res/null_sim_res_noDetQ_tmle_T2.RDS"))
...
saveRDS(resdf_ic, paste0(here::here(),"/sim_res/null_sim_res_noDetQ_ic_T2.RDS"))
...
saveRDS(resdf_Qint_ic, paste0(here::here(),"/sim_res/null_sim_res_ic_T2.RDS"))
